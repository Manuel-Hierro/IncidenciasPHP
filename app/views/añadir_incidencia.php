...
<div class="card-body">
    ...
    <div class="">
        <form action="<?= base_url ?>incidencia/añadir_incidencia_comprobar" method="POST" enctype="multipart/form-data">
            <!-- PRIORIDAD -->
            ...
            <div class="form-group text-center">
                ...
                <a class="btn btn-outline-primary" href="<?= base_url ?>incidencia/incidencias">Atras</a>
            </div>
            <!-- ENVIAR -->
        </form>
    </div>
